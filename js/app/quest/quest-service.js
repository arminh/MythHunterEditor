...
(function () {
    ...
    QuestFactory.$inject = ["$log","$modal", "$q", "AuthenticationService", "BackendService", "MarkerType", "TreePartType", "Task", "HtmlText", "TreePart"];

    /* @ngInject */
    function QuestFactory($log, $modal, $q, AuthenticationService, BackendService, MarkerType, TreePartType, Task, HtmlText, TreePart) {
        ...
        function create(creatorId) {
            ...
            $log.info("create");
            openQuestDialog(this).then(questCreated.bind(this), createQuestCanceled);
        ...
        function initFromRemote(remoteQuest) {
            ...
            function initTreeParts(results) {
                return BackendService.getTreePart(remoteQuest.getTreeRootId()).then(initTreePart.bind(this));

                function initTreePart(result) {
                    var treePartRoot = new TreePart(null);

                    treePartRoot.initFromRemote(result, this, true);
                    treePartRoot.task = results[0];
                    return treePartRoot;
                }
            }
            ...
            function initQuest(results) {
                ...
                deffered.resolve(this);
                $log.info("initFromRemote_success: ", remoteQuest);
            }
