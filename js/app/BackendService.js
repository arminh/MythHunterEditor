...
//
// Constructor for XML Schema item {http://backend.com/wsdl}delteQuestResponse
//
function backend_com_wsdl_delteQuestResponse () {
    this.typeMarker = 'backend_com_wsdl_delteQuestResponse';
}

//
// Serialize {http://backend.com/wsdl}delteQuestResponse
//
function backend_com_wsdl_delteQuestResponse_serialize(cxfjsutils, elementName, extraNamespaces) {
    var xml = '';
    if (elementName != null) {
     xml = xml + '<';
     xml = xml + elementName;
...
backend_com_wsdl_delteQuestResponse.prototype.serialize = backend_com_wsdl_delteQuestResponse_serialize;

function backend_com_wsdl_delteQuestResponse_deserialize (cxfjsutils, element) {
    var newobject = new backend_com_wsdl_delteQuestResponse();
    cxfjsutils.trace('element: ' + cxfjsutils.traceElementName(element));
    var curElement = cxfjsutils.getFirstElementChild(element);
    var item;
    return newobject;
...
//
// accessor is backend_com_wsdl_invisibleMarker.prototype.getPopupHtmlId
// element get for popupHtmlId
// - element type is {http://www.w3.org/2001/XMLSchema}long
// - required element
//
// element set for popupHtmlId
// setter function is is backend_com_wsdl_invisibleMarker.prototype.setPopupHtmlId
//
function backend_com_wsdl_invisibleMarker_getPopupHtmlId() { return this._popupHtmlId;}

backend_com_wsdl_invisibleMarker.prototype.getPopupHtmlId = backend_com_wsdl_invisibleMarker_getPopupHtmlId;

function backend_com_wsdl_invisibleMarker_setPopupHtmlId(value) { this._popupHtmlId = value;}

backend_com_wsdl_invisibleMarker.prototype.setPopupHtmlId = backend_com_wsdl_invisibleMarker_setPopupHtmlId;
//
...
function backend_com_wsdl_invisibleMarker_serialize(cxfjsutils, elementName, extraNamespaces) {
    ...
    {
     xml = xml + '<popupHtmlId>';
     xml = xml + cxfjsutils.escapeXmlEntities(this._popupHtmlId);
     xml = xml + '</popupHtmlId>';
    }
    // block for local variables
    {
...
function backend_com_wsdl_invisibleMarker_deserialize (cxfjsutils, element) {
    ...
    cxfjsutils.trace('curElement: ' + cxfjsutils.traceElementName(curElement));
    cxfjsutils.trace('processing popupHtmlId');
    var value = null;
    if (!cxfjsutils.isElementNil(curElement)) {
     value = cxfjsutils.getNodeText(curElement);
     item = parseInt(value);
    }
    newobject.setPopupHtmlId(item);
    var item = null;
    if (curElement != null) {
     curElement = cxfjsutils.getNextElementSibling(curElement);
    }
...
//
// Constructor for XML Schema item {http://backend.com/wsdl}delteQuest
//
function backend_com_wsdl_delteQuest () {
    this.typeMarker = 'backend_com_wsdl_delteQuest';
    this._arg0 = 0;
}

//
// accessor is backend_com_wsdl_delteQuest.prototype.getArg0
// element get for arg0
// - element type is {http://www.w3.org/2001/XMLSchema}long
// - required element
//
// element set for arg0
// setter function is is backend_com_wsdl_delteQuest.prototype.setArg0
//
function backend_com_wsdl_delteQuest_getArg0() { return this._arg0;}

backend_com_wsdl_delteQuest.prototype.getArg0 = backend_com_wsdl_delteQuest_getArg0;

function backend_com_wsdl_delteQuest_setArg0(value) { this._arg0 = value;}

backend_com_wsdl_delteQuest.prototype.setArg0 = backend_com_wsdl_delteQuest_setArg0;
//
// Serialize {http://backend.com/wsdl}delteQuest
//
function backend_com_wsdl_delteQuest_serialize(cxfjsutils, elementName, extraNamespaces) {
    var xml = '';
    if (elementName != null) {
     xml = xml + '<';
     xml = xml + elementName;
...
backend_com_wsdl_delteQuest.prototype.serialize = backend_com_wsdl_delteQuest_serialize;

function backend_com_wsdl_delteQuest_deserialize (cxfjsutils, element) {
    var newobject = new backend_com_wsdl_delteQuest();
    cxfjsutils.trace('element: ' + cxfjsutils.traceElementName(element));
    var curElement = cxfjsutils.getFirstElementChild(element);
    var item;
    cxfjsutils.trace('curElement: ' + cxfjsutils.traceElementName(curElement));
...
//
// accessor is backend_com_wsdl_quizMarker.prototype.getQuizHtmlId
// element get for quizHtmlId
// - element type is {http://www.w3.org/2001/XMLSchema}long
// - required element
//
// element set for quizHtmlId
// setter function is is backend_com_wsdl_quizMarker.prototype.setQuizHtmlId
//
function backend_com_wsdl_quizMarker_getQuizHtmlId() { return this._quizHtmlId;}

backend_com_wsdl_quizMarker.prototype.getQuizHtmlId = backend_com_wsdl_quizMarker_getQuizHtmlId;

function backend_com_wsdl_quizMarker_setQuizHtmlId(value) { this._quizHtmlId = value;}

backend_com_wsdl_quizMarker.prototype.setQuizHtmlId = backend_com_wsdl_quizMarker_setQuizHtmlId;
//
...
function backend_com_wsdl_quizMarker_serialize(cxfjsutils, elementName, extraNamespaces) {
    ...
    {
     xml = xml + '<quizHtmlId>';
     xml = xml + cxfjsutils.escapeXmlEntities(this._quizHtmlId);
     xml = xml + '</quizHtmlId>';
    }
    if (elementName != null) {
     xml = xml + '</';
...
function backend_com_wsdl_quizMarker_deserialize (cxfjsutils, element) {
    ...
    cxfjsutils.trace('curElement: ' + cxfjsutils.traceElementName(curElement));
    cxfjsutils.trace('processing quizHtmlId');
    var value = null;
    if (!cxfjsutils.isElementNil(curElement)) {
     value = cxfjsutils.getNodeText(curElement);
     item = parseInt(value);
    }
    newobject.setQuizHtmlId(item);
    var item = null;
    if (curElement != null) {
     curElement = cxfjsutils.getNextElementSibling(curElement);
    }
...
function backend_com_wsdl_IBackend () {
    ...
    this.globalElementSerializers['{http://backend.com/wsdl}delteQuest'] = backend_com_wsdl_delteQuest_serialize;
    this.globalElementDeserializers['{http://backend.com/wsdl}delteQuest'] = backend_com_wsdl_delteQuest_deserialize;
    ...
    this.globalElementSerializers['{http://backend.com/wsdl}delteQuestResponse'] = backend_com_wsdl_delteQuestResponse_serialize;
    this.globalElementDeserializers['{http://backend.com/wsdl}delteQuestResponse'] = backend_com_wsdl_delteQuestResponse_deserialize;
...
function backend_com_wsdl_delteQuest_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling backend_com_wsdl_delteQuestResponse_deserializeResponse');
     responseObject = backend_com_wsdl_delteQuestResponse_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

backend_com_wsdl_IBackend.prototype.delteQuest_onsuccess = backend_com_wsdl_delteQuest_op_onsuccess;

function backend_com_wsdl_delteQuest_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
backend_com_wsdl_IBackend.prototype.delteQuest_onerror = backend_com_wsdl_delteQuest_op_onerror;

//
// Operation {http://backend.com/wsdl}delteQuest
// Wrapped operation.
// parameter arg0
// - simple type {http://www.w3.org/2001/XMLSchema}long//
function backend_com_wsdl_delteQuest_op(successCallback, errorCallback, arg0) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(1);
    args[0] = arg0;
    xml = this.delteQuest_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.delteQuest_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.delteQuest_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
...
backend_com_wsdl_IBackend.prototype.delteQuest = backend_com_wsdl_delteQuest_op;

function backend_com_wsdl_delteQuest_serializeInput(cxfjsutils, args) {
    var wrapperObj = new backend_com_wsdl_delteQuest();
    wrapperObj.setArg0(args[0]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='http://backend.com/wsdl' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:delteQuest', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

backend_com_wsdl_IBackend.prototype.delteQuest_serializeInput = backend_com_wsdl_delteQuest_serializeInput;

function backend_com_wsdl_delteQuestResponse_deserializeResponse(cxfjsutils, partElement) {
}
